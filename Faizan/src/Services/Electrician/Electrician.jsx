...
import ElectricianApi from "./ElectricianApi";
const Electrician = (props) => {
  const {CartHandler}=props;
  const [ElectricianData] = useState(ElectricianApi);
  console.log(ElectricianData);
  return (
    <div className="container-fluid c-row">
      <div className="row ">
        {ElectricianData.map((e) => (
          <div className="col-12 col-md-4">
            <div class="card" style={{ width: "28rem" }}>
              <img style={{height:"200px"}} src={e.image} class="Electriciand-img-top" alt="..." />
              <div class="card-body">
